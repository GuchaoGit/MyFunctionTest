package com.guc.mylibrary.widgets.pickerview.lib;
...
import com.guc.mylibrary.widgets.pickerview.adaper.WheelAdapter;
import com.guc.mylibrary.widgets.pickerview.listener.OnItemSelectedListener;
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        if (attrs != null) {
            ...
            textColorCenter = a.getColor(R.styleable.WheelView_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.WheelView_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.WheelView_pickerview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.WheelView_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
