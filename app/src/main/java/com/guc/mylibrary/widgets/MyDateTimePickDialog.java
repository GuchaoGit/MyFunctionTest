...
import com.guc.mylibrary.utils.commonadapter.CommonUtil;
...
public class MyDateTimePickDialog implements DatePicker.OnDateChangedListener,
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (null != mListener) {
                    mListener.onDateTimeSet(true, c,dp, tp, year, monthOfYear,
                            dayOfMonth, hourOfDay, minute,CommonUtil.getStrFromCalendar(c,CommonUtil.pattern1).equals("")?"请选择时间":CommonUtil.getStrFromCalendar(c,CommonUtil.pattern1));
                }
            }
        });
    ...
    public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
        ...
        dialog.setTitle(CommonUtil.getStrFromCalendar(c,CommonUtil.pattern1).equals("")?"请选择时间":CommonUtil.getStrFromCalendar(c,CommonUtil.pattern1));
    }
