...
import com.guc.mylibrary.widgets.pickerview.listener.OnDismissListener;
import com.guc.mylibrary.widgets.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void createDialog() {
        if (dialogView != null) {
            ...
            mDialog.getWindow().setWindowAnimations(R.style.MyDialog);
