package com.guc.mylibrary.dialogchooseinfo;
...
public class DialogChooseInfoUtils {
    public static void showDialogChooseInfoMultiple(String title, List<BeanChooseOption> datas, List<BeanChooseOption> seldatas, FragmentManager fragmentManager, DialogChooseInfoMultiple.OnChooseInfoClickListener onChooseInfoClickListener) {
        DialogChooseInfoMultiple dialog = new DialogChooseInfoMultiple();
        dialog.setSelectValue(seldatas);
        Bundle bundle = new Bundle();
        BeanChooseInfo data = new BeanChooseInfo();
        data.title = title;
        data.beanChooseOptionList = datas;
        bundle.putParcelable("data", data);
        dialog.setArguments(bundle);
        dialog.show(fragmentManager, DialogChooseInfoMultiple.TAG);
        dialog.setOnChooseInfoClickListener(onChooseInfoClickListener);
    }
